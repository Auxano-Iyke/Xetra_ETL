...
class XetraSourceConfig(NamedTuple):
    ...
    src_first_extra_date: determines the date for extracting the source
...
class XetraTargetConfig(NamedTuple):
    ...
    trg_col_isin: column name for target
...
class XetraETL():
    ...
    def __init__(self, s3_bucket_src: S3BucketConnector,
        ...
        :param trg_args: NameTouple class with target configuration data
        """
